...
Akkio_Consume_Helper_Data.allBuffs = {
  ...
  { name = "Major Troll's Blood Potion",         icon = "Interface\\Icons\\INV_Potion_79",               buffIcon = "Interface\\Icons\\INV_Potion_79",                                                                                           canBeAnounced = false, duration = 3600, itemID = 20004 },
